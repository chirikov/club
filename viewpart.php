...
print "<table align=\"center\" width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\">
       <tr><td bgcolor=$bgt1 colspan=2>&nbsp <img src='str.gif' align=center> <b>Записи с $ppart по $ppart2 :</b></td></tr>
        ";
...
Имя : <input type=text  value='' name=name size=41><br>   
Почта : <input type=text value='' name=email size=39><br>   
